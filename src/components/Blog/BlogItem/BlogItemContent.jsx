const BlogItemContent = () => {
  return (
    <section className="bg-cf-light-white">
      <div className="pt-[60px] text-cf-coffee max-w-[940px] mx-auto ">
        ...
        <p className="mb-5 md:mb-[30px] lg:mb-10 px-5 lg:px-[50px]">
        ...
        <div className="mb-5 md:mb-[30px] rounded-2xl overflow-hidden">
          <iframe
            className="w-full aspect-video"
            src="https://www.youtube.com/embed/1bn8cQ-9-KM?si=NVoMLmddAmBNfKm2"
