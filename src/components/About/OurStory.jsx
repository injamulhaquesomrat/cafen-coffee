    ...
    <div className="py-20 md:py-[100px] border-y border-cf-coffee bg-foreground text-center">
      <Container>
        ...
        <div className="flex flex-row flex-wrap gap-4 justify-center lg:justify-between items-center max-w-[900px]  mx-auto">
          <div className="flex gap-2.5 xl:gap-3 items-center text-cf-coffee">
            <div>
              <h4 className="text-[40px] xl:text-5xl font-nunito leading-tight tracking-tighter font-medium">12K</h4>
            </div>
            <div>
              <span className="xl:text-lg">Happy customers</span>
            </div>
          </div>
          <div className="flex gap-2.5 xl:gap-3 items-center text-cf-coffee">
            <div>
              <h4 className="text-[40px] xl:text-5xl font-nunito leading-tight tracking-tighter font-medium">8+</h4>
            </div>
            <div>
              <span className="xl:text-lg">Years in business</span>
            </div>
          </div>
          <div className="flex gap-2.5 xl:gap-3 items-center text-cf-coffee">
            <div>
              <h4 className="text-[40px] xl:text-5xl font-nunito leading-tight tracking-tighter font-medium">100+</h4>
            </div>
            <div>
              <span className="xl:text-lg">Daily visitors</span>
            </div>
          </div>
        </div>
