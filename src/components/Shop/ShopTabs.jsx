      ...
      {shopTabItems &&
        ...
        shopTabItems.map((item) => (
          <button
            ...
            className={`inline-flex w-full sm:w-fit justify-center border border-cf-coffee px-[30px] sm:px-10 py-2.5 rounded-full bg-cf-light-yellow text-cf-coffee font-sober font-bold tracking-tighter cursor-pointer ${
