    ...
    <div className="grid grid-cols-12 gap-5 lg:gap-10 justify-center items-center">
      ...
      <div className="bg-cf-light-yellow p-5 sm:p-7 lg:p-12 flex flex-col gap-5 md:gap-7 lg:gap-7 rounded-xl lg:rounded-3xl shadow-md w-full col-span-12 md:col-span-7 h-full">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <input
            className="px-5 py-2.5 rounded-lg border border-cf-coffee outline-none bg-cf-light-yellow placeholder:text-cf-coffee placeholder:text-base col-span-1"
            type="text"
            placeholder="Name"
          />
          <input
            className="px-5 py-2.5 rounded-lg border border-cf-coffee outline-none bg-cf-light-yellow placeholder:text-cf-coffee col-span-1"
            type="email"
            placeholder="Email"
          />
        </div>
